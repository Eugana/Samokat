      ...
      <div className="mainProduct__shelf__item" >
        <div onClick={() => this.props.onShowItem(this.props.item)}>
          <div className="mainProduct__shelf__img__container">
            <div className="mainProduct__shelf__img__text">{this.props.item.salle}</div>
        ...
        <button className="mainProduct__shelf__btn">
          ...
          <div className="mainProduct__shelf__btn__secondPrice">{this.props.item.nowPrice}</div>
          <i className="mainProduct__shelf__btn__icon  vbf-plus-big" onClick={() => this.props.onAdd(this.props.item)}></i>
        </button>
      </div>
    )
  }
