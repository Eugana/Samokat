...
class App extends React.Component {
  ...
  render() {
    return (
      <div className="App">
        <MainProduct items={this.state.items} onAdd={this.addToOrder} onDelete={this.deletOrder} orders={this.state.orders} onShowItem={this.onShowItem} />
        {this.state.showFullItem && <ShowFullItem onAdd={this.addToOrder} onShowItem={this.onShowItem} items={this.state.items} item={this.state.fullItem} />}
      </div>
    );
  }
  onShowItem(item) {
